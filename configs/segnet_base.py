...
def get_opts(Train=True):
    ...
    #                   x : 对应yolov7_x
    #############################################################################################    
    opt.net = 'segnet'     # [unet, pspnet, segnet, fcn, deconvnet, fpn, deeplab_v3, deeplab_v3_plus, segformer]
    opt.model_path      = '' #coco
    ...
    if Train:
        ...
        from seg_model.segnet.segnet import SegNet
        opt.Model_Pred = SegNet  
    return opt
