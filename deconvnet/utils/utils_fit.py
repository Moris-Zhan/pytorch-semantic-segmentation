...
from deconvnet.nets.deconvnet_training import CE_Loss, Dice_loss, Focal_Loss
from deconvnet.utils.utils import get_lr
from deconvnet.utils.utils_metrics import f_score
...
def fit_one_epoch_no_val(model_train, model, loss_history, optimizer, epoch, epoch_step, gen, Epoch, cuda, dice_loss, focal_loss, cls_weights, num_classes):
    ...
    loss_history.append_loss_no_val(total_loss/(epoch_step+1), epoch+1)
    print('Finish Validation')
    print('Epoch:'+ str(epoch+1) + '/' + str(Epoch))
