...
from model.backbone.resnet import ResNet101, ResNet50
...
class FPN(nn.Module):
    ...
    def __init__(self, num_classes, back_bone_name='resnet', pretrained=True):
        ...
        self.back_bone_name = back_bone_name
        num_blocks = [2,4,23,3]
