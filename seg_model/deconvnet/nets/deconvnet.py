...
from seg_model.deconvnet.utils.utils import set_trainable
# import torchvision.models as models
from seg_model.deconvnet.nets.vgg import VGG16_BN
...
class DeconvNet(nn.Module):
    ...
    # cost too memory -----------> nedd to change to here
    # def freeze_backbone(self):
    #     set_trainable([self.conv1, self.conv2, self.conv3, self.conv4, self.conv5, self.deconv67], False)

    # def unfreeze_backbone(self):
    #     set_trainable([self.conv1, self.conv2, self.conv3, self.conv4, self.conv5, self.deconv67], True)


    def freeze_backbone(self):
        set_trainable([self.conv1, self.conv2, self.conv3, self.conv4, self.conv5, self.conv67, self.deconv67], False)

    def unfreeze_backbone(self):
        set_trainable([self.conv1, self.conv2, self.conv3, self.conv4, self.conv5, self.conv67, self.deconv67], True)