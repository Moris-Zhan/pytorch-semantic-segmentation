...
from seg_model.deconvnet.utils.utils import preprocess_input, cvtColor
from seg_model.deconvnet.utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
import torch


class DeconvNetDataset(Dataset):
    def __init__(self, annotation_lines, input_shape, num_classes, train, dataset_path):
        super(DeconvNetDataset, self).__init__()
...
def deconvnet_dataset_collate(batch):
    images      = []
    pngs        = []
    seg_labels  = []
