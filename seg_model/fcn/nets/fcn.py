...
from seg_model.fcn.utils.utils import set_trainable, get_upsampling_weight
from itertools import chain
from seg_model.fcn.nets.vgg import VGG16
...
class FCN(nn.Module):
    ...
    def unfreeze_backbone(self):
        set_trainable([self.pool3, self.pool4, self.pool5], True)