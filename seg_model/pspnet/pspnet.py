...
from seg_model.pspnet.nets.pspnet import PSPNet as pspnet
from seg_model.pspnet.utils.utils import cvtColor, preprocess_input, resize_image
...
class PSPNet(object):
    _defaults = {
        ...
        #   所需要区分的类的个数+1
        #-------------------------------------------------------------------#
        "model_path"        : 'logs\PSPNet\ep100-loss0.007-val_loss0.010.pth',
        "num_classes"       : 11 + 1,    
