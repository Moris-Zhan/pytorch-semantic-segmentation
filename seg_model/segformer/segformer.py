...
from seg_model.segformer.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class SegFormer_Segmentation(object):
    _defaults = {
        ...
        "model_path"        : "work_dirs/lane_segformer/best_epoch_weights.pth",
        #----------------------------------------#
        #   所使用的的主干网络：
        #   b0、b1、b2、b3、b4、b5
        #----------------------------------------#
