...
from seg_model.deeplabv3_plus.utils.utils import cvtColor, preprocess_input, resize_image
...
class DeeplabV3(object):
    _defaults = {
        ...
        #   所需要区分的类的个数+1
        #-------------------------------------------------------------------#
        "model_path"        : 'work_dirs/lane_deeplab_v3_plus/best_epoch_weights.pth',        
        "num_classes"       : 11 + 1,    
        #----------------------------------------#
