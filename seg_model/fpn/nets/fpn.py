...
from seg_model.fpn.utils.utils import set_trainable
import torch.nn.functional as F
from seg_model.fpn.nets.backbone import ResNet101
...
class FPN(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=True):
        ...
        self.back_bone = ResNet101(pretrained=pretrained)  
    ...
    def freeze_backbone(self):
        set_trainable([self.back_bone], False)

    def unfreeze_backbone(self):
        set_trainable([self.back_bone], True)