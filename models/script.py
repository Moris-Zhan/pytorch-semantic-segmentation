...
import os
from utils.tools import CE_Loss, Focal_Loss, Dice_loss, f_score


def fit_unet(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, dice_loss, focal_loss, cls_weights, num_classes, opt):
    total_loss      = 0
    total_f_score   = 0
...
def get_fit_func(opt):
    if opt.net == 'unet':
        ...
        return fit_deeplab_v3_plus
    elif opt.net == 'segformer':
        return fit_segformer
    else:
        return fit_model